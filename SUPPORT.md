...
Need help with Stentorosaur? Here's how to get support.
...
- [Contributing Guide](https://amiable.dev/blog/stentorosaur-contributing) - How to help
- [AI Features](https://amiable.dev/blog/stentorosaur-ai-features) - Future roadmap
...
- **🎉 Show and Tell** - Share your Stentorosaur setup
...
1. **Search existing issues** - Might already be proposed
2. **Check roadmap** - Might already be planned
3. **Start a discussion** - Get community feedback first
...
Need faster response times or custom development?
...
- **Training** - Team training on Stentorosaur
- **Consulting** - Architecture and monitoring strategy

Contact: [support@amiable.dev](mailto:support@amiable.dev)

### Sponsorship

Support the project and get priority support:
...
- **GitHub:** [Watch releases](https://github.com/amiable-dev/docusaurus-plugin-stentorosaur) for updates
- **npm:** [`@amiable-dev/docusaurus-plugin-stentorosaur`](https://www.npmjs.com/package/@amiable-dev/docusaurus-plugin-stentorosaur)
- **Blog:** [Amiable Dev Blog](https://amiable.dev/blog)
- **Twitter:** [@AmiableDev](https://twitter.com/AmiableDev)
...
- **General questions:** [GitHub Discussions](https://github.com/amiable-dev/docusaurus-plugin-stentorosaur/discussions)
- **Bug reports:** [GitHub Issues](https://github.com/amiable-dev/docusaurus-plugin-stentorosaur/issues)
- **Security issues:** [security@amiable.dev](mailto:security@amiable.dev)
- **Commercial support:** [support@amiable.dev](mailto:support@amiable.dev)
- **General inquiries:** [hello@amiable.dev](mailto:hello@amiable.dev)

---

Thank you for using Stentorosaur! 🦖
